...
pagefixture_1.default.describe('Checkout Flow - Missing Fields', () => {
    ...
    (0, pagefixture_1.default)('SD-07: Checkout with Missing Required Fields @Regression', (_a) => __awaiter(void 0, [_a], void 0, function* ({ productPage, cartPage, checkOutPage }) {
        yield productPage.addFirstProductToCart();
        yield cartPage.navigateToCart();
        yield cartPage.proceedToCheckout();
        yield checkOutPage.fillUserInfo('John', '', '');
        const errorText = yield checkOutPage.getErrorText();
        (0, test_1.expect)(errorText).toContain('Error:');
    }));
});
